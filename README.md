...
```mermaid
flowchart TB
    subgraph Strategy["本專案測試策略"]
        direction TB
        E2E["🔺 E2E 測試\n(PoC 範圍外)"]
        INT["🔷 整合測試 - Testcontainers\n8 場景 × 3-4 IT 類別\n真實容器，行為驗證"]
        UNIT["🟩 單元測試 - Container Factory\ntc-common 模組\nSingleton 驗證"]
    end
